...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      description:
        'Crafting an inviting first impression, the facade is the artistry that welcomes you home. ',
    ...
    },
    {
      ...
      name: 'PUJA GHAR',
      description:
        'Elevate your spiritual space with a Pooja Ghar that radiates serenity and devotion. ',
    ...
    },
    {
      ...
      name: 'RETAIL',
      description:
        'Your retail experience with spaces designed to captivate and inspire. ',
    ...
    },
    {
      ...
      name: 'MASTER-BEDROOM',
      description:
        'Transform your bedroom into a sanctuary of dreams and relaxation. ',
    ...
    },
    {
      ...
      name: 'LIVING ROOM',
      description:
        'Where comfort meets style, your living room, a heaven of harmony. ',
      image: '/image/Double height.jpg',
    },
    {
      id: 8,
      name: 'KIDS-ROOM',
      description:
        'Designing dreams and fostering imagination in every corner of your childs room. ',
