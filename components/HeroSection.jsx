      ...
      <div className="container py-8 text-center lg:py-0 lg:text-left lg:flex lg:justify-between ">
        <div className="lg:w-1/2 xl:py-14 lg:py-8">
          ...
          <p className="pb-6 text-gray-500 xl:pb-10">
            ...
            office into a productivity heaven or curating the perfect ambiance
            for a trendy restaurant I thrive on bringing visions to life. I
            truly believe that every space has a unique story to tell and
            I&apos;m here to be its storyteller. My mission is to craft
            interiors that not only look breathtaking but also make a real
            difference in the lives of those who experience them. Let&apos;s
            collaborate and turn your space into a masterpiece that truly
